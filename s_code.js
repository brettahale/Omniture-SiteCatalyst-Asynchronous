var SiteCatQueue = function () {
	
/************* DO NOT ALTER ANYTHING BELOW THIS LINE ! **************/
var s_code='',s_objectID;s_gi =function(un,pg,ss){var c="s.version='H.24.3';s.an=s_an;s.logDebug=function(m){var s=this,tcf=new Function('var e;try{console.log(\"'+s.rep(s.rep(m,\"\\n\",\"\\\\n\"),\""
...
function s_giqf(){var w=window,q=w.s_giq,i,t,s;if(q)for(i=0;i<q.length;i++){t=q[i];s=s_gi(t.oun);s.sa(t.un);s.setTagContainer(t.tagContainerName)}w.s_giq=0}s_giqf()
    ...
    this.push = function(){for (var i = 0; i < arguments.length; i++) try {if (typeof arguments[i] === "function") arguments[i]();else {this[arguments[i][0]].apply(this, arguments[i].slice(1));}} catch (e) {console.log(e)}}
    this.s_init = function (){
    	this.s = s_gi(arguments[0]);
		/************************** CONFIG SECTION **************************/
		/* You may add or alter any code config here. */
		this.s.charSet="ISO-8859-1"
		/* Conversion Config */
		...
		this.s.linkInternalFilters="javascript:,www.servicemagic.com"
		...
		this.s.visitorNamespace="INSERT_NAMESPACE"
		this.s.trackingServer="INSERT_TRACKING_SERVER"
	...
	this.setVar  =function(){
		for (var i = 0; i < arguments.length; i++) try {
			...
			this.s[arguments[i][0]] = arguments[i][1];
		}catch (e) {console.log(e)}
		
	}
	
	this.s_fire = function(){
		var s_code = this.s.t();
	}

};

var _old_sm= window._sm;
window._sm = new SiteCatQueue();
window._sm.push.apply(window._sm, _old_sm);